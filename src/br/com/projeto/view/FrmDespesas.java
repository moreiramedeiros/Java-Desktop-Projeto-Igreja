...
public class FrmDespesas extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        List<Despesas> lista = dao.listarDespesas();
        ...
        for (Despesas c : lista) {
            tabela.addRow(new Object[]{
                ...
                c.getDescricao(),
                c.getValor(),
                util.converteDataUsaParaBr(c.getData_despesa()),
                c.getIgreja().getNome()
            });
        }
    }
    ...
    public void limparCampos() {
        ...
        Utilitarios util = new Utilitarios();
        txtData_despesa.setText(util.converteDataAtualParaBr());
    ...
    private void initComponents() {
        ...
        txtData_despesa = new javax.swing.JFormattedTextField();
        ...
        try {
            txtData_despesa.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        ...
        cbDescricao.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cbDescricao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Água", "Alimentação", "Energia", "Informática", "Internet", "Limpeza", "Obra/Manutenção", "Outros" }));
        cbDescricao.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbDescricaoItemStateChanged(evt);
            }
        });
        cbDescricao.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cbDescricaoMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                cbDescricaoMouseReleased(evt);
            }
        });
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtData_despesa, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtValor, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 461, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(txtData_despesa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTabbedPane1.addTab("Cadastro de Despesas", jPanel2);
        ...
        jTabbedPane1.addTab("Pesquisar Despesas", jPanel3);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            obj.setDescricao(cbDescricao.getSelectedItem().toString());
            String valor_ = txtValor.getText();
            valor_ = valor_.replace(",", ".");
            obj.setValor(Double.parseDouble(valor_));
            obj.setData_despesa(util.converteDataBrParaUSA(txtData_despesa.getText()));
    ...
    private void tabelaMembrosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMembrosMousePressed
     ...
     //    if ((evt.getModifiers() & InputEvent.BUTTON1_MASK) != 0) {
            ...
            cbDescricao.setSelectedItem(tabelaMembros.getValueAt(tabelaMembros.getSelectedRow(), 1).toString());
            txtValor.setText(tabelaMembros.getValueAt(tabelaMembros.getSelectedRow(), 2).toString());
            txtData_despesa.setText(tabelaMembros.getValueAt(tabelaMembros.getSelectedRow(), 3).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DespesasDAO dao = new DespesasDAO();
        List<Despesas> lista = dao.buscarDespesasPorDescricao(nome);
    ...
    private void cbDescricaoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbDescricaoItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cbDescricaoItemStateChanged

    private void cbDescricaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbDescricaoMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_cbDescricaoMouseClicked

    private void cbDescricaoMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbDescricaoMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_cbDescricaoMouseReleased
    ...
    private javax.swing.JFormattedTextField txtData_despesa;
